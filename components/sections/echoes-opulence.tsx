    ...
    <section className="relative bg-gradient-to-b from-[#8D927B] via-[#B8B8A6] to-[#F3EEE8] py-24 md:py-32 lg:py-40 overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-8 md:px-12">
        <div className="grid md:grid-cols-2 gap-12 md:gap-16 lg:gap-28 items-center">
          ...
          {/* Right - Model with Outfit Changes */}
          <motion.div
            initial={{ opacity: 0, x: 50 }}
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true }}
          ...
          >
            <div className="relative aspect-[3/4] w-full max-w-[300px] sm:max-w-[340px] md:max-w-[380px] lg:max-w-[420px] rounded-xl overflow-hidden">
