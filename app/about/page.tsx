...
export default function AboutPage() {
  ...
  return (
    <div ref={containerRef} className="min-h-screen bg-background overflow-x-hidden">
              ...
              {navLinks.map((link) => (
                <Link
                  ...
                  className={`text-[11px] font-medium transition-colors duration-500 tracking-[0.15em] uppercase ${
                    link.href === "/about" ? "text-gold" : "text-charcoal/70 hover:text-gold"
                  }`}
                >
                  {link.name}
                </Link>
      ...
      <section className="relative h-[70vh] md:h-[80vh] overflow-hidden">
        ...
        <div className="relative z-10 flex h-full flex-col items-center justify-center px-6 text-center pt-20">
          ...
          <motion.p
            ...
            className="mt-6 md:mt-8 max-w-xl text-sm md:text-base text-white/70 leading-relaxed"
          >
      ...
      <section className="bg-ivory py-20 md:py-28 lg:py-36">
        <div className="mx-auto max-w-7xl px-6 md:px-12">
          <div className="grid md:grid-cols-2 gap-12 md:gap-16 lg:gap-24 items-center">
            ...
            >
              <span className="text-xs uppercase tracking-[0.3em] text-gold">The Vision</span>
              <h2 className="mt-4 font-serif text-3xl md:text-4xl lg:text-5xl font-light text-charcoal leading-[1.15]">
                Ordinary Was
                <br />
                Never An Option
              </h2>
              <div className="mt-8 space-y-5 text-charcoal/70 text-sm md:text-base leading-[1.8]">
                <p>
              ...
              <Link
                href="/shop"
                className="mt-10 inline-flex items-center gap-3 text-sm font-medium text-charcoal group"
              >
                <span className="border-b border-charcoal pb-0.5 group-hover:border-gold group-hover:text-gold transition-all duration-500">
                  Explore Our Collection
                </span>
                <ArrowRight className="h-4 w-4 transition-transform group-hover:translate-x-2 group-hover:text-gold duration-500" />
              </Link>
            </motion.div>
            ...
            >
              ...
              {/* Floating accent */}
              <div className="absolute -bottom-6 -left-6 md:-bottom-8 md:-left-8 w-32 h-32 md:w-40 md:h-40 bg-gold/10 rounded-xl -z-10" />
            </motion.div>
          </div>
        </div>
      </section>
      ...
      <section className="bg-background-dark py-20 md:py-28 lg:py-36">
        <div className="mx-auto max-w-7xl px-6 md:px-12">
          ...
          >
            ...
            <h2 className="mt-4 font-serif text-3xl md:text-4xl lg:text-5xl font-light text-foreground-light">
              Our Values
            </h2>
          </motion.div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-10">
            {values.map((value, index) => (
              ...
              >
                <div className="mb-6 inline-flex p-4 rounded-full border border-gold/30 bg-gold/5 group-hover:bg-gold/10 group-hover:border-gold/50 transition-all duration-500">
                  <value.icon className="h-6 w-6 md:h-7 md:w-7 text-gold" strokeWidth={1.25} />
                </div>
                <h3 className="font-serif text-lg md:text-xl font-medium text-foreground-light mb-3">
                  {value.title}
                </h3>
      ...
      <section className="bg-ivory py-20 md:py-28 lg:py-36">
        <div className="mx-auto max-w-5xl px-6 md:px-12">
          <motion.div
            ...
            className="text-center mb-16 md:mb-20"
          >
            <span className="text-xs uppercase tracking-[0.3em] text-gold">Our Journey</span>
            <h2 className="mt-4 font-serif text-3xl md:text-4xl lg:text-5xl font-light text-charcoal">
              Milestones
            </h2>
          </motion.div>
          ...
          <div className="relative">
            ...
            <div className="space-y-12 md:space-y-16">
              {milestones.map((milestone, index) => (
                ...
                >
                  {/* Dot */}
                  <div className="absolute left-4 md:left-1/2 w-3 h-3 bg-gold rounded-full md:-translate-x-1/2 z-10" />
                  
                  {/* Content */}
                  <div className={`ml-12 md:ml-0 md:w-1/2 ${index % 2 === 0 ? "md:pr-16 md:text-right" : "md:pl-16"}`}>
                    <span className="text-2xl md:text-3xl font-serif text-gold font-light">{milestone.year}</span>
                    <h3 className="mt-2 font-serif text-lg md:text-xl font-medium text-charcoal">
                      {milestone.title}
                    </h3>
      ...
      <section className="bg-charcoal py-20 md:py-28 lg:py-36">
        <div className="mx-auto max-w-4xl px-6 md:px-12 text-center">
          <motion.div
            ...
            transition={{ duration: 1 }}
          >
            <div className="w-20 h-20 md:w-24 md:h-24 mx-auto mb-8 rounded-full overflow-hidden border-2 border-gold/30">
              <Image
            ...
            <blockquote className="font-serif text-xl sm:text-2xl md:text-3xl lg:text-4xl font-light text-ivory leading-[1.4] italic">
              &ldquo;Fashion should never be ordinary. It should challenge, inspire, and empower. That&apos;s the essence of WHAT IF WEAR.&rdquo;
            </blockquote>
            <div className="mt-8">
              <p className="text-gold font-medium tracking-wide">The Founders</p>
              <p className="text-ivory/50 text-sm mt-1">WHAT IF WEAR</p>
            </div>
          </motion.div>
        </div>
      </section>
